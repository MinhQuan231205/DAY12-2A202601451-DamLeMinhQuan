...
| Repo | https://github.com/MinhQuan231205/DAY12-2A202601451-DamLeMinhQuan |

## Service

| Mục | Nội dung |
|-----|----------|
| Public URL | https://day12-agent-efqr.onrender.com |
...
| `REDIS_URL` | ✅ | tự nối từ service Key Value `day12-redis` (Render) |
...
```
$ curl -i https://day12-agent-efqr.onrender.com/health
HTTP/1.1 200 OK
content-type: application/json
{"status":"ok","service":"day12-agent","version":"1.0.0"}

$ curl -i https://day12-agent-efqr.onrender.com/ready
HTTP/1.1 200 OK
content-type: application/json
{"status":"ready","redis":true}

$ curl -i -X POST https://day12-agent-efqr.onrender.com/ask \
...
$ for i in $(seq 1 15); do
    curl -s -o /dev/null -w "%{http_code} " -X POST \
      https://day12-agent-efqr.onrender.com/ask \
      -H "Content-Type: application/json" \
      -H "X-API-Key: $AGENT_API_KEY" -H "X-User-Id: sv-test" \
      -d '{"question":"test"}'
  done; echo
